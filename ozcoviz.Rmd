...
Project is initiated and led by [Timothy Churches](https://timchurches.github.io/blog/about.html) (South Western Sydney Clinical School, UNSW Medicine, and the Ingham Institute for Applied Medical Research. [Nicholas Tierney](https://www.njtierney.com/) (Monash University Econometrics and Business Statistics Research Group) is the co-lead, and has contributed much of the code and contributed to the documenation and commentary. 

We also thank [Stuart Lee](https://stuartlee.org/), [Dianne Cook](http://dicook.org/), [Miles McBain](https://github.com/MilesMcBain), and [Rob Hyndman](https://robjhyndman.com/) for their helpful comments and contribution of R code (some of which is yet to appear).
...
Most countries are decreasing, but we notice that Japan and Singapore are fluctuating, due to recent recrudescent outbreaks.
