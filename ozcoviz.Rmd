...
suppressMessages({
  anim_save("log-log-incidence.gif", animation=p, duration=60, height=500, width=800, nframes=nframes*2, detail=5, start_pause=5, end_pause=10, rewind=TRUE)
})
```

```{r cum-incidence-incidence-fig, fig.height = 8, fig.width = 12}
knitr::include_graphics("log-log-incidence.gif")
```
